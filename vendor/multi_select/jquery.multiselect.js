...
(function ($) {
    var defaults = {
        ...
        // plugin texts
        texts: {
            placeholder: '請選擇', // text to use in dummy input
            search: '搜尋', // search input placeholder text
            searchNoResult: '沒有結果', // search results not found text
            selectedOptions: ' 已選擇', // selected suffix text
            selectAll: '全部', // select all text
            unselectAll: '取消全選', // unselect all text
            noneSelected: '沒有選擇', // None selected text
        },
    ...
    MultiSelect.prototype = {
        ...
        load: function () {
                ...
                .on('mousedown', function (event) {
                    ...
                    $('.ms-options-wrap.ms-active').each(function () {
                        if (
                            ...
                            optionsWrap.parent().siblings('.ms-list-' + instance.listNumber + '.jqmsLoaded')[0]
                        ) {
            ...
            if (instance.options.selectAll) {
                optionsList.before(
                    '<a href="#" class="ms-selectall global">' + instance.options.texts.selectAll + '</a>'
                );
            }
            ...
            optionsWrap.on('click', '.ms-selectall', function (event) {
                ...
                if ($(this).hasClass('global')) {
                    ...
                    if (
                        ...
                        optionsList
                            .find('li:not(.optgroup, .selected, .ms-hidden) input[type="checkbox"]:not(:disabled)')
                            .closest('li')
                            .addClass('selected');
                    ...
                    // deselect everything
                        ...
                        optionsList
                            .find('li:not(.optgroup, .ms-hidden).selected input[type="checkbox"]:not(:disabled)')
                            .closest('li')
                ...
                // OPTGROUP
                    ...
                    if (appendContainer) {
                        ...
                        if (instance.options.selectGroup) {
                            container.append(
                                '<a href="#" class="ms-selectall">' + instance.options.texts.selectAll + '</a>'
                            );
                        }
            ...
            if (
                ...
                if (chkbx.length) {
                    ...
                    optionsList
                        ...
                        .css('padding-left', parseInt(chkbx.closest('label').css('padding-left')) * 2 + checkboxWidth);
        ...
        _updatePlaceholderText: function () {
            ...
            // if copy is larger than button width use "# selected"
                ...
                (placeholderTxt.width() > placeholder.width() || selOpts.length != selectVals.length)
            ) {
